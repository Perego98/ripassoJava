...
public class TestGarage {
	...
	static void riparaVeicoli(Vehicle [] veicoli) {
		for(int i = 0; i < veicoli.length; i++) {
			if(((int) (Math.random()*10))%2 == 0) {
				System.out.println("Guasto: " + veicoli[i].isGuasta() + " Prezzo riparazione: " +
						new Garage().repair(veicoli[i]));
			}
		}
	}
