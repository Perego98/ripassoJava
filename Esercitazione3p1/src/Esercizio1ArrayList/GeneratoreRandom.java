...
public class GeneratoreRandom {
	...
	static void provaEx1() {
		// array non ordinato
		ArrayList<Integer> ar1 = creaRandom(20, 51);
		
		System.out.println("Stampo array non ordinato ArrayList");
		stampa(ar1.iterator());
		...
		System.out.println("Stampo array ordinato ArrayList");
		stampa(ar1.iterator());
